...
CREATE TABLE album (
  ...
  discid VARCHAR(255),
  artist_id INT(11),
  composer_id INT(11) DEFAULT '1',
  conductor_id INT(11) DEFAULT '1',
  genre_id INT(11),
  name VARCHAR(255) NOT NULL,
  year VARCHAR(4),
  comment TEXT,
  ...
  inherit_artist int(1) NOT NULL default '0',
  _perm_user INT(16) DEFAULT '1',
  _perm_group INT(16) DEFAULT '1',
  _perm_access INT(16) DEFAULT '664',
...
CREATE TABLE track (
  ...
  _perm_group INT(16) DEFAULT '1',
  _perm_access INT(16) DEFAULT '664',
  UNIQUE track (album_id,artist_id,title,track_num),
  PRIMARY KEY (id)
);

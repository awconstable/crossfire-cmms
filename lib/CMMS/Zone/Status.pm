...
sub pause {
	...
	$mc->query("REPLACE INTO zone_mem (zone,param,value) VALUES('$self->{zone}->{number}', 'state', 'pause')");
...
sub playing {
	...
	$mc->query("REPLACE INTO zone_mem (zone,param,value) VALUES('$self->{zone}->{number}', 'state', 'play')");
